		...
		<SheetPortal>
			...
			<SheetPrimitive.Content
				...
				className={cn(
					...
					side === "left" &&
						"inset-y-0 left-0 h-full w-[var(--sheet-side-w)] max-w-[var(--sheet-side-w)] overflow-y-auto border-r pl-safe data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left",
					side === "top" &&
						"inset-x-0 top-0 h-auto max-h-[85dvh] overflow-y-auto border-b data-[state=closed]:slide-out-to-top data-[state=open]:slide-in-from-top",
					side === "bottom" &&
						"inset-x-0 bottom-0 h-auto max-h-[85dvh] overflow-y-auto border-t pb-safe data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom",
					className,
				)}
				{...props}
			>
